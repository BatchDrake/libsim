...
void *
sorted_list_search (void **list, double index)
{
...
void *
sorted_list_get_next (void **list, double index)
{
  struct sorted_list_head *this;
...
void *
sorted_list_get_previous (void **list, double index)
{
  struct sorted_list_head *this;
...
void
sorted_list_insert (void **list, void *element, double index)
{
  void *alike;
